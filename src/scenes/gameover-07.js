...
export default class GameOver07 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('book-open-07', 'Result/book-open-07.png')
    }
    ...
    create() {
        ...
        const bg = this.add.image(width * 0.5, height * 0.5, 'gameover-bg-07')
            .setOrigin(0.5)
        ...
        const bookOpen = this.add.image(width * 0.5, height * 0.5, 'book-open-07')
            .setOrigin(0.5)
            .setDisplaySize(width, height)
            .setAlpha(0)
            .setDepth(6)
