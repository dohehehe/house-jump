...
export default class GameOver01 extends Phaser.Scene {
    constructor() {
        super("gameover-01")
    }
    ...
    preload() {
        ...
        this.load.image('gameover-bg-01', 'Result/fail-01.jpg')
        ...
        this.load.image('book-open-01', 'Result/book-open-01.png')
    }
    ...
    create() {
        ...
        const bg = this.add.image(width * 0.5, height * 0.5, 'gameover-bg-01')
            .setOrigin(0.5)
        ...
        const bookOpen = this.add.image(width * 0.5, height * 0.5, 'book-open-01')
            .setOrigin(0.5)
            .setDisplaySize(width, height)
            .setAlpha(0)
            .setDepth(6)
