...
export default class GameOver05 extends Phaser.Scene {
    constructor() {
        super("gameover-05")
    }
    ...
    create() {
        ...
        const bgTexture = this.textures.get('gameover-bg-05')
        ...
        const bg = this.add.image(width * 0.5, height, 'gameover-bg-05')
            .setOrigin(0.5, 1)
