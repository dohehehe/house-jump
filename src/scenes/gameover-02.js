...
export default class GameOver02 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('gameover-bg-02', 'Result/fail-01.jpg')
        ...
        this.load.image('book-open-02', 'Result/book-open-02.png')
    }
    ...
    create() {
        ...
        const bg = this.add.image(width * 0.5, height * 0.5, 'gameover-bg-02')
            .setOrigin(0.5)
        ...
        const bookOpen = this.add.image(width * 0.5, height * 0.5, 'book-open-02')
            .setOrigin(0.5)
            .setDisplaySize(width, height)
            .setAlpha(0)
            .setDepth(6)
