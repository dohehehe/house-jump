...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.questionNumberText = this.add.text(this.GAME_CENTER_X, 880, '', qNumberStyle).setScrollFactor(0).setOrigin(0.5, 0.5).setDepth(11)
        ...
        this.questionText = this.add.text(this.GAME_CENTER_X, 950, '', qStyle).setScrollFactor(0).setOrigin(0.5, 0).setDepth(11).setLineSpacing(25)
