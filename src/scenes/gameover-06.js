...
export default class GameOver06 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('book-open-06', 'Result/book-open-06.png')
    }
    ...
    create() {
        ...
        const bg = this.add.image(width * 0.5, height * 0.5, 'gameover-bg-06')
            .setOrigin(0.5)
        ...
        const bookOpen = this.add.image(width * 0.5, height * 0.5, 'book-open-06')
            .setOrigin(0.5)
            .setDisplaySize(width, height)
            .setAlpha(0)
            .setDepth(6)
