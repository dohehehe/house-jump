...
export default class GameOver03 extends Phaser.Scene {
    constructor() {
        super("gameover-03")
    }
    ...
    preload() {
        ...
        this.load.image('gameover-bg-03', 'Result/fail-01.jpg')
        ...
        this.load.image('book-open-03', 'Result/book-open-03.png')
    }
    ...
    create() {
        ...
        const bg = this.add.image(width * 0.5, height * 0.5, 'gameover-bg-03')
            .setOrigin(0.5)
        ...
        const bookOpen = this.add.image(width * 0.5, height * 0.5, 'book-open-03')
            .setOrigin(0.5)
            .setDisplaySize(width, height)
            .setAlpha(0)
            .setDepth(6)
